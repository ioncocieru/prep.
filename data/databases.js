...
window.EXAM_DATA.databases = {
  ...
  QUESTIONS: [
    ...
    },
    {
      ...
      type: "single",
      question: "Ce returnează interogarea de mai jos?",
      code: "SELECT nume FROM Angajati\nWHERE salariu > 5000\nORDER BY nume ASC;",
      options: [
        "Toți angajații, sortați descrescător după salariu",
        "Numele angajaților cu salariu peste 5000, sortate alfabetic crescător",
        "Numărul angajaților cu salariu peste 5000",
        "Eroare de sintaxă"
      ],
      correct: 1,
      explanation: "WHERE filtrează angajații cu salariu > 5000, iar ORDER BY nume ASC sortează rezultatele alfabetic crescător."
    },
    {
      id: "db-006",
      chapter: "extragere-date",
