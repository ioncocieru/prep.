/* =====================================================================
   ...
   Câmpuri comune tuturor tipurilor:
     ...
     table     -> (opțional, NOU) un tabel afișat sub întrebare — vezi mai jos
   ...
   TABEL ÎN ÎNTREBARE (NOU) — nu e un tip nou, ci un câmp opțional "table"
   pe care îl poți adăuga la ORICE tip de întrebare de mai sus (true_false,
   single, multiple sau drag_drop), exact ca și "code". Util când vrei ca
   utilizatorul să citească un tabel (ex: date dintr-un tabel SQL, o listă
   de porturi/protocoale, valori de variabile) înainte să răspundă.

      table: {
        caption: "Tabelul Angajati",      // opțional, o mică etichetă deasupra
   ...
   Poți combina "code" ȘI "table" pe aceeași întrebare dacă vrei (de exemplu
   un tabel cu date + o interogare SQL dedesubt). Nu șterge capitolele din
   CHAPTERS — poți doar să adaugi întrebări noi cu "chapter" = id-ul
   capitolului potrivit. Poți adăuga 300+ întrebări, pur și simplu continuă
   lista din interiorul parantezelor pătrate [ ].
   ===================================================================== */
  ...
  QUESTIONS: [
    {
      ...
      type: "single",
      question: "Consider the following Python code:\n\n```\nage = 0\nminor = False\nname = 'Durga'\n```\n\nThe types of age, minor and name variables respectively are:",
      options: ["int, bool, str", "bool, bool, str", "int, bool, char", "float, bool, str"],
      correct: 0,
      explanation: "age = 0 is int, minor = False is bool, name = 'Durga' is str."
    },
    {
      id: "py-002",
      chapter: "operatori-tipuri",
    ...
    },
    {
      ...
      chapter: "structuri-date",
      type: "single",
      question: "Ai dicționarul de mai jos, construit dintr-un tabel de note. Ce returnează note[\"Andrei\"]?",
      table: {
        caption: "Sursa datelor — note.csv",
        headers: ["elev", "nota"],
        rows: [
          ["Maria", 9],
          ["Andrei", 7],
      ...
      code: "note = {\"Maria\": 9, \"Andrei\": 7, \"Ioana\": 10}\nprint(note[\"Andrei\"])",
      options: ["7", "\"Andrei\"", "Eroare de tip", "None"],
      correct: 0,
      explanation: "Accesarea unui dicționar prin cheie (note[\"Andrei\"]) returnează valoarea asociată acelei chei, aici 7."
    }
  ]
};
