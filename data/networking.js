...
window.EXAM_DATA.networking = {
  ...
  QUESTIONS: [
    ...
    },
    {
      ...
      type: "single",
      question: "Ai tabelul de mai jos cu claseleprivate de adrese IP. Din ce clasă face parte 172.20.4.10?",
      table: {
        caption: "Intervale de adrese private (RFC 1918)",
        headers: ["Clasă", "Interval"],
        rows: [
          ["A privată", "10.0.0.0 – 10.255.255.255"],
          ["B privată", "172.16.0.0 – 172.31.255.255"],
          ["C privată", "192.168.0.0 – 192.168.255.255"]
        ]
      },
      options: ["Clasa A privată", "Clasa B privată", "Clasa C privată", "Adresă publică"],
      correct: 1,
      explanation: "172.20.4.10 se încadrează în intervalul 172.16.0.0 – 172.31.255.255, deci face parte din Clasa B privată."
    },
    {
      id: "net-005",
      chapter: "infrastructura",
