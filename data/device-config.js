...
window.EXAM_DATA.deviceConfig = {
  ...
  QUESTIONS: [
    ...
    },
    {
      ...
      type: "single",
      question: "Ai tabelul de mai jos, extras din Event Viewer. Ce tip de eveniment ar trebui investigat cel mai urgent?",
      table: {
        caption: "Event Viewer — Jurnal sistem",
        headers: ["Ora", "Sursă", "Nivel", "ID eveniment"],
        rows: [
          ["09:12", "Service Control Manager", "Informație", "7036"],
          ["09:15", "Disk", "Eroare", "7"],
          ["09:20", "Kernel-General", "Informație", "12"]
        ]
      },
      options: [
        "Evenimentul de la 09:12 (Informație)",
        "Evenimentul de la 09:15 (Eroare, sursa Disk)",
        "Evenimentul de la 09:20 (Informație)",
        "Niciunul — toate sunt normale"
      ],
      correct: 1,
      explanation: "Un eveniment de nivel \"Eroare\" provenit de la sursa Disk semnalează o problemă hardware sau de I/O și trebuie investigat cu prioritate față de evenimentele informative."
    },
    {
      id: "dcm-010",
      chapter: "management-depanare",
